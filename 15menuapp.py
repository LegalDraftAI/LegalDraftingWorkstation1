...
with tab_work:
    ...
    with c1:
        if st.button("🔍 Search API", use_container_width=True):
            st.session_state.search_results = [{"title": "Kerala HC Precedent 2025", "cite": "2025 KER 101", "sum": "Similar facts regarding this petition."}]
    with c2:
